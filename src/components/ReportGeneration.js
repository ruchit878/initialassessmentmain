...
const ReportGeneration = ({ resumeData, analysisType, psychometricResults }) => {
  ...
  const downloadPDF = () => {
    ...
    pdf.text('Windsurf Career Analysis Report', margin, yPosition);
    yPosition += 20;
    ...
    pdf.save('windsurf-career-report.pdf');
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              ...
              <h1 className="text-xl font-bold text-gray-900">Windsurf</h1>
            </div>
            <div className="flex items-center">
              <button
                onClick={downloadPDF}
      ...
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mt-12 py-8">
          <p className="text-gray-500 text-sm">
            Generated by Windsurf AI Career Partner • {new Date().toLocaleDateString()}
          </p>
        </div>
      </div>
    </div>
